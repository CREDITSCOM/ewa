...
public class APIResponse implements org.apache.thrift.TBase<APIResponse, APIResponse._Fields>, java.io.Serializable, Cloneable, Comparable<APIResponse> {
  ...
  public java.util.Map<java.lang.String,com.credits.thrift.generated.Variant> contractVariables; // optional
  ...
  public APIResponse setContractVariables(java.util.Map<java.lang.String,com.credits.thrift.generated.Variant> contractVariables) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.contractVariables = new java.util.HashMap<java.lang.String,com.credits.thrift.generated.Variant>(2*_map0.size);
      ...
      if (struct.contractVariables != null) {
        if (struct.isSetContractVariables()) {
          oprot.writeFieldBegin(CONTRACT_VARIABLES_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, com.credits.thrift.generated.Variant> _iter4 : struct.contractVariables.entrySet())
            {
      ...
      if (struct.isSetContractVariables()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, com.credits.thrift.generated.Variant> _iter5 : struct.contractVariables.entrySet())
          {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.contractVariables = new java.util.HashMap<java.lang.String,com.credits.thrift.generated.Variant>(2*_map6.size);
