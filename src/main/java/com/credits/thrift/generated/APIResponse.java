...
public class APIResponse implements org.apache.thrift.TBase<APIResponse, APIResponse._Fields>, java.io.Serializable, Cloneable, Comparable<APIResponse> {
  ...
  public com.credits.thrift.generated.Variant ret_val; // required
  public java.util.Map<String,com.credits.thrift.generated.Variant> contractVariables; // required
  ...
  public APIResponse(
    ...
    com.credits.thrift.generated.Variant ret_val,
    java.util.Map<String,com.credits.thrift.generated.Variant> contractVariables)
  {
    this();
    this.code = code;
    setCodeIsSet(true);
  ...
  public APIResponse(APIResponse other) {
    ...
    if (other.isSetContractVariables()) {
      java.util.Map<String,com.credits.thrift.generated.Variant> __this__contractVariables = new java.util.HashMap<String,com.credits.thrift.generated.Variant>(other.contractVariables.size());
      for (java.util.Map.Entry<String, com.credits.thrift.generated.Variant> other_element : other.contractVariables.entrySet()) {
  ...
  public APIResponse setRet_val(com.credits.thrift.generated.Variant ret_val) {
    this.ret_val = ret_val;
    return this;
  }
  ...
  public void putToContractVariables(String key, com.credits.thrift.generated.Variant val) {
    if (this.contractVariables == null) {
      this.contractVariables = new java.util.HashMap<String,com.credits.thrift.generated.Variant>();
    }
    this.contractVariables.put(key, val);
  }

  public java.util.Map<String,com.credits.thrift.generated.Variant> getContractVariables() {
    return this.contractVariables;
  }

  public APIResponse setContractVariables(java.util.Map<String,com.credits.thrift.generated.Variant> contractVariables) {
    this.contractVariables = contractVariables;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case CONTRACT_VARIABLES:
      if (value == null) {
        ...
        setContractVariables((java.util.Map<String,com.credits.thrift.generated.Variant>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.contractVariables = new java.util.HashMap<String,com.credits.thrift.generated.Variant>(2*_map0.size);
                String _key1;
                com.credits.thrift.generated.Variant _val2;
                for (int _i3 = 0; _i3 < _map0.size; ++_i3)
                {
                  _key1 = iprot.readString();
                  _val2 = new com.credits.thrift.generated.Variant();
                  _val2.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, APIResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.contractVariables != null) {
        oprot.writeFieldBegin(CONTRACT_VARIABLES_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<String, com.credits.thrift.generated.Variant> _iter4 : struct.contractVariables.entrySet())
          {
      ...
      if (struct.isSetContractVariables()) {
        {
          ...
          for (java.util.Map.Entry<String, com.credits.thrift.generated.Variant> _iter5 : struct.contractVariables.entrySet())
          {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.contractVariables = new java.util.HashMap<String,com.credits.thrift.generated.Variant>(2*_map6.size);
          String _key7;
          com.credits.thrift.generated.Variant _val8;
          for (int _i9 = 0; _i9 < _map6.size; ++_i9)
          {
            _key7 = iprot.readString();
            _val8 = new com.credits.thrift.generated.Variant();
            _val8.read(iprot);
