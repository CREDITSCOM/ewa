...
public class APIResponse implements org.apache.thrift.TBase<APIResponse, APIResponse._Fields>, java.io.Serializable, Cloneable, Comparable<APIResponse> {
  ...
  public APIResponse(APIResponse other) {
    ...
    if (other.isSetContractVariables()) {
      java.util.Map<String,Variant> __this__contractVariables = new java.util.HashMap<String,Variant>(other.contractVariables.size());
      for (java.util.Map.Entry<String, Variant> other_element : other.contractVariables.entrySet()) {
  ...
  public void putToContractVariables(String key, Variant val) {
    if (this.contractVariables == null) {
      this.contractVariables = new java.util.HashMap<String,Variant>();
    }
    this.contractVariables.put(key, val);
  }

  public java.util.Map<String,Variant> getContractVariables() {
    return this.contractVariables;
  }

  public APIResponse setContractVariables(java.util.Map<String,Variant> contractVariables) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case CONTRACT_VARIABLES:
      if (value == null) {
        ...
        setContractVariables((java.util.Map<String,Variant>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.contractVariables = new java.util.HashMap<String,Variant>(2*_map0.size);
                String _key1;
                Variant _val2;
      ...
      if (struct.contractVariables != null) {
        if (struct.isSetContractVariables()) {
          oprot.writeFieldBegin(CONTRACT_VARIABLES_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<String, Variant> _iter4 : struct.contractVariables.entrySet())
            {
      ...
      if (struct.isSetContractVariables()) {
        {
          ...
          for (java.util.Map.Entry<String, Variant> _iter5 : struct.contractVariables.entrySet())
          {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.contractVariables = new java.util.HashMap<String,Variant>(2*_map6.size);
          String _key7;
          Variant _val8;
