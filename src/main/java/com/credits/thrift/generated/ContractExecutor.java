...
public class ContractExecutor {
  ...
  public interface Iface {
    ...
    public APIResponse executeByteCode(String address, java.nio.ByteBuffer byteCode, java.nio.ByteBuffer contractState, String method, java.util.List<String> params) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void executeByteCode(String address, java.nio.ByteBuffer byteCode, java.nio.ByteBuffer contractState, String method, java.util.List<String> params, org.apache.thrift.async.AsyncMethodCallback<APIResponse> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_executeByteCode(String address, java.nio.ByteBuffer byteCode, java.nio.ByteBuffer contractState, String method, java.util.List<String> params) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class executeByteCode_call extends org.apache.thrift.async.TAsyncMethodCall<APIResponse> {
      ...
      public executeByteCode_call(String address, java.nio.ByteBuffer byteCode, java.nio.ByteBuffer contractState, String method, java.util.List<String> params, org.apache.thrift.async.AsyncMethodCallback<APIResponse> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
  ...
  public static class executeByteCode_args implements org.apache.thrift.TBase<executeByteCode_args, executeByteCode_args._Fields>, java.io.Serializable, Cloneable, Comparable<executeByteCode_args>   {
    ...
    public executeByteCode_args setAddress(String address) {
      this.address = address;
      return this;
    }
    ...
    public executeByteCode_args setParams(java.util.List<String> params) {
      this.params = params;
      return this;
    }
    ...
    public int compareTo(executeByteCode_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetByteCode()).compareTo(other.isSetByteCode());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetByteCode()) {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.params = new java.util.ArrayList<String>(_list10.size);
                  String _elem11;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, executeByteCode_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.params != null) {
          oprot.writeFieldBegin(PARAMS_FIELD_DESC);
          {
            ...
            for (String _iter13 : struct.params)
            {
        ...
        if (struct.isSetParams()) {
          {
            ...
            for (String _iter14 : struct.params)
            {
        ...
        if (incoming.get(4)) {
          {
            ...
            struct.params = new java.util.ArrayList<String>(_list15.size);
            String _elem16;
