              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.id = new java.util.ArrayList<java.lang.Long>(_list92.size);
                  long _elem93;
                  for (int _i94 = 0; _i94 < _list92.size; ++_i94)
                  {
                    _elem93 = iprot.readI64();
                    struct.id.add(_elem93);
                  }
                  iprot.readListEnd();
                }
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.id = new java.util.ArrayList<java.lang.Long>(_list97.size);
            long _elem98;
            for (int _i99 = 0; _i99 < _list97.size; ++_i99)
            {
              _elem98 = iprot.readI64();
              struct.id.add(_elem98);
            }
          }
          struct.setIdIsSet(true);
        }
