            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.argTypes = new java.util.ArrayList<java.lang.String>(_list76.size);
                java.lang.String _elem77;
                for (int _i78 = 0; _i78 < _list76.size; ++_i78)
                {
                  _elem77 = iprot.readString();
                  struct.argTypes.add(_elem77);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MethodDescription struct) throws org.apache.thrift.TException {
      ...
      if (struct.argTypes != null) {
        oprot.writeFieldBegin(ARG_TYPES_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter79 : struct.argTypes)
          {
      ...
      if (struct.isSetArgTypes()) {
        {
          ...
          for (java.lang.String _iter80 : struct.argTypes)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.argTypes = new java.util.ArrayList<java.lang.String>(_list81.size);
          java.lang.String _elem82;
          for (int _i83 = 0; _i83 < _list81.size; ++_i83)
          {
            _elem82 = iprot.readString();
            struct.argTypes.add(_elem82);
          }
        }
        struct.setArgTypesIsSet(true);
      }
