            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.methods = new java.util.ArrayList<MethodDescription>(_list84.size);
                MethodDescription _elem85;
                for (int _i86 = 0; _i86 < _list84.size; ++_i86)
                {
                  _elem85 = new MethodDescription();
                  _elem85.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ContractAllMethodsGetResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.methods != null) {
        oprot.writeFieldBegin(METHODS_FIELD_DESC);
        {
          ...
          for (MethodDescription _iter87 : struct.methods)
          {
            _iter87.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetMethods()) {
        {
          ...
          for (MethodDescription _iter88 : struct.methods)
          {
            _iter88.write(oprot);
          }
        }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.methods = new java.util.ArrayList<MethodDescription>(_list89.size);
          MethodDescription _elem90;
          for (int _i91 = 0; _i91 < _list89.size; ++_i91)
          {
            _elem90 = new MethodDescription();
            _elem90.read(iprot);
