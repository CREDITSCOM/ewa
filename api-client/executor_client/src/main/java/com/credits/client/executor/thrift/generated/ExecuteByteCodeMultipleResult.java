            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.results = new java.util.ArrayList<GetterMethodResult>(_list8.size);
                GetterMethodResult _elem9;
                for (int _i10 = 0; _i10 < _list8.size; ++_i10)
                {
                  _elem9 = new GetterMethodResult();
                  _elem9.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ExecuteByteCodeMultipleResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.results != null) {
        oprot.writeFieldBegin(RESULTS_FIELD_DESC);
        {
          ...
          for (GetterMethodResult _iter11 : struct.results)
          {
            _iter11.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetResults()) {
        {
          ...
          for (GetterMethodResult _iter12 : struct.results)
          {
            _iter12.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.results = new java.util.ArrayList<GetterMethodResult>(_list13.size);
          GetterMethodResult _elem14;
          for (int _i15 = 0; _i15 < _list13.size; ++_i15)
          {
            _elem14 = new GetterMethodResult();
            _elem14.read(iprot);
