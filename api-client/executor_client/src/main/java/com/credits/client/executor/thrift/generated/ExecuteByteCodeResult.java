...
public class ExecuteByteCodeResult implements org.apache.thrift.TBase<ExecuteByteCodeResult, ExecuteByteCodeResult._Fields>, java.io.Serializable, Cloneable, Comparable<ExecuteByteCodeResult> {
  ...
  private static final org.apache.thrift.protocol.TField EXTERNAL_CONTRACTS_STATE_FIELD_DESC = new org.apache.thrift.protocol.TField("externalContractsState", org.apache.thrift.protocol.TType.LIST, (short)3);
  ...
  public java.util.List<java.nio.ByteBuffer> externalContractsState; // required
  ...
  public ExecuteByteCodeResult(
    ...
    java.util.List<java.nio.ByteBuffer> externalContractsState)
  {
    this();
    this.status = status;
  ...
  public ExecuteByteCodeResult(ExecuteByteCodeResult other) {
    ...
    if (other.isSetExternalContractsState()) {
      java.util.List<java.nio.ByteBuffer> __this__externalContractsState = new java.util.ArrayList<java.nio.ByteBuffer>(other.externalContractsState);
  ...
  public java.util.Iterator<java.nio.ByteBuffer> getExternalContractsStateIterator() {
    return (this.externalContractsState == null) ? null : this.externalContractsState.iterator();
  }

  public void addToExternalContractsState(java.nio.ByteBuffer elem) {
    if (this.externalContractsState == null) {
      this.externalContractsState = new java.util.ArrayList<java.nio.ByteBuffer>();
    }
    this.externalContractsState.add(elem);
  }

  public java.util.List<java.nio.ByteBuffer> getExternalContractsState() {
    return this.externalContractsState;
  }

  public ExecuteByteCodeResult setExternalContractsState(java.util.List<java.nio.ByteBuffer> externalContractsState) {
    this.externalContractsState = externalContractsState;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case EXTERNAL_CONTRACTS_STATE:
      if (value == null) {
        ...
        setExternalContractsState((java.util.List<java.nio.ByteBuffer>)value);
      }
      break;
  ...
  public String toString() {
    ...
    if (this.externalContractsState == null) {
      ...
      org.apache.thrift.TBaseHelper.toString(this.externalContractsState, sb);
    }
    first = false;
    if (isSetRet_val()) {
      if (!first) sb.append(", ");
  ...
  private static class ExecuteByteCodeResultStandardScheme extends org.apache.thrift.scheme.StandardScheme<ExecuteByteCodeResult> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.externalContractsState = new java.util.ArrayList<java.nio.ByteBuffer>(_list0.size);
                java.nio.ByteBuffer _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  _elem1 = iprot.readBinary();
                  struct.externalContractsState.add(_elem1);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ExecuteByteCodeResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.externalContractsState != null) {
        ...
        {
          oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, struct.externalContractsState.size()));
          for (java.nio.ByteBuffer _iter3 : struct.externalContractsState)
          {
      ...
      if (struct.isSetExternalContractsState()) {
        {
          ...
          for (java.nio.ByteBuffer _iter4 : struct.externalContractsState)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.externalContractsState = new java.util.ArrayList<java.nio.ByteBuffer>(_list5.size);
          java.nio.ByteBuffer _elem6;
          for (int _i7 = 0; _i7 < _list5.size; ++_i7)
          {
            _elem6 = iprot.readBinary();
            struct.externalContractsState.add(_elem6);
          }
        }
        struct.setExternalContractsStateIsSet(true);
      }
