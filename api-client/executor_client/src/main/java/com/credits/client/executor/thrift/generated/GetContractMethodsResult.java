            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.methods = new java.util.ArrayList<MethodDescription>(_list8.size);
                MethodDescription _elem9;
                for (int _i10 = 0; _i10 < _list8.size; ++_i10)
                {
                  _elem9 = new MethodDescription();
                  _elem9.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetContractMethodsResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.methods != null) {
        oprot.writeFieldBegin(METHODS_FIELD_DESC);
        {
          ...
          for (MethodDescription _iter11 : struct.methods)
          {
            _iter11.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetMethods()) {
        {
          ...
          for (MethodDescription _iter12 : struct.methods)
          {
            _iter12.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.methods = new java.util.ArrayList<MethodDescription>(_list13.size);
          MethodDescription _elem14;
          for (int _i15 = 0; _i15 < _list13.size; ++_i15)
          {
            _elem14 = new MethodDescription();
            _elem14.read(iprot);
