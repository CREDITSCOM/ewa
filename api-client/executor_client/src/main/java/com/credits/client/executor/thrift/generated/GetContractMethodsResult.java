...
public class GetContractMethodsResult implements org.apache.thrift.TBase<GetContractMethodsResult, GetContractMethodsResult._Fields>, java.io.Serializable, Cloneable, Comparable<GetContractMethodsResult> {
  ...
  public int compareTo(GetContractMethodsResult other) {
    ...
    lastComparison = Boolean.valueOf(isSetMethods()).compareTo(other.isSetMethods());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMethods()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetContractMethodsResult(");
    boolean first = true;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.methods = new java.util.ArrayList<com.credits.general.thrift.generated.MethodDescription>(_list16.size);
                com.credits.general.thrift.generated.MethodDescription _elem17;
                for (int _i18 = 0; _i18 < _list16.size; ++_i18)
                {
                  _elem17 = new com.credits.general.thrift.generated.MethodDescription();
                  _elem17.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetContractMethodsResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.methods != null) {
        oprot.writeFieldBegin(METHODS_FIELD_DESC);
        {
          ...
          for (com.credits.general.thrift.generated.MethodDescription _iter19 : struct.methods)
          {
            _iter19.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetMethods()) {
        {
          ...
          for (com.credits.general.thrift.generated.MethodDescription _iter20 : struct.methods)
          {
            _iter20.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.methods = new java.util.ArrayList<com.credits.general.thrift.generated.MethodDescription>(_list21.size);
          com.credits.general.thrift.generated.MethodDescription _elem22;
          for (int _i23 = 0; _i23 < _list21.size; ++_i23)
          {
            _elem22 = new com.credits.general.thrift.generated.MethodDescription();
            _elem22.read(iprot);
