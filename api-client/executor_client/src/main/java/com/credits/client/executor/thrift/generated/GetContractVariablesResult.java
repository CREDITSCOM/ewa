...
public class GetContractVariablesResult implements org.apache.thrift.TBase<GetContractVariablesResult, GetContractVariablesResult._Fields>, java.io.Serializable, Cloneable, Comparable<GetContractVariablesResult> {
  ...
  public java.util.Map<String,com.credits.general.thrift.generated.Variant> contractVariables; // required
  ...
  public GetContractVariablesResult(
    ...
    java.util.Map<String,com.credits.general.thrift.generated.Variant> contractVariables)
  {
    this();
    this.status = status;
  ...
  public GetContractVariablesResult(GetContractVariablesResult other) {
    ...
    if (other.isSetContractVariables()) {
      java.util.Map<String,com.credits.general.thrift.generated.Variant> __this__contractVariables = new java.util.HashMap<String,com.credits.general.thrift.generated.Variant>(other.contractVariables.size());
      for (java.util.Map.Entry<String, com.credits.general.thrift.generated.Variant> other_element : other.contractVariables.entrySet()) {
  ...
  public void putToContractVariables(String key, com.credits.general.thrift.generated.Variant val) {
    if (this.contractVariables == null) {
      this.contractVariables = new java.util.HashMap<String,com.credits.general.thrift.generated.Variant>();
    }
    this.contractVariables.put(key, val);
  }

  public java.util.Map<String,com.credits.general.thrift.generated.Variant> getContractVariables() {
    return this.contractVariables;
  }

  public GetContractVariablesResult setContractVariables(java.util.Map<String,com.credits.general.thrift.generated.Variant> contractVariables) {
    this.contractVariables = contractVariables;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case CONTRACT_VARIABLES:
      if (value == null) {
        ...
        setContractVariables((java.util.Map<String,com.credits.general.thrift.generated.Variant>)value);
      }
      break;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetContractVariablesResult(");
    boolean first = true;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.contractVariables = new java.util.HashMap<String,com.credits.general.thrift.generated.Variant>(2*_map26.size);
                String _key27;
                com.credits.general.thrift.generated.Variant _val28;
                for (int _i29 = 0; _i29 < _map26.size; ++_i29)
                {
                  _key27 = iprot.readString();
                  _val28 = new com.credits.general.thrift.generated.Variant();
                  _val28.read(iprot);
                  struct.contractVariables.put(_key27, _val28);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetContractVariablesResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.contractVariables != null) {
        oprot.writeFieldBegin(CONTRACT_VARIABLES_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<String, com.credits.general.thrift.generated.Variant> _iter30 : struct.contractVariables.entrySet())
          {
      ...
      if (struct.isSetContractVariables()) {
        {
          ...
          for (java.util.Map.Entry<String, com.credits.general.thrift.generated.Variant> _iter31 : struct.contractVariables.entrySet())
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.contractVariables = new java.util.HashMap<String,com.credits.general.thrift.generated.Variant>(2*_map32.size);
          String _key33;
          com.credits.general.thrift.generated.Variant _val34;
          for (int _i35 = 0; _i35 < _map32.size; ++_i35)
          {
            _key33 = iprot.readString();
            _val34 = new com.credits.general.thrift.generated.Variant();
            _val34.read(iprot);
            struct.contractVariables.put(_key33, _val34);
          }
        }
        struct.setContractVariablesIsSet(true);
      }
