...
public class ClassObject implements org.apache.thrift.TBase<ClassObject, ClassObject._Fields>, java.io.Serializable, Cloneable, Comparable<ClassObject> {
  ...
  public ClassObject setByteCodeObjects(java.util.List<ByteCodeObject> byteCodeObjects) {
    this.byteCodeObjects = byteCodeObjects;
    return this;
  }
  ...
  public ClassObject setInstance(java.nio.ByteBuffer instance) {
    this.instance = org.apache.thrift.TBaseHelper.copyBinary(instance);
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.byteCodeObjects = new java.util.ArrayList<ByteCodeObject>(_list68.size);
                ByteCodeObject _elem69;
                for (int _i70 = 0; _i70 < _list68.size; ++_i70)
                {
                  _elem69 = new ByteCodeObject();
                  _elem69.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ClassObject struct) throws org.apache.thrift.TException {
      ...
      if (struct.byteCodeObjects != null) {
        oprot.writeFieldBegin(BYTE_CODE_OBJECTS_FIELD_DESC);
        {
          ...
          for (ByteCodeObject _iter71 : struct.byteCodeObjects)
          {
            _iter71.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetByteCodeObjects()) {
        {
          ...
          for (ByteCodeObject _iter72 : struct.byteCodeObjects)
          {
            _iter72.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.byteCodeObjects = new java.util.ArrayList<ByteCodeObject>(_list73.size);
          ByteCodeObject _elem74;
          for (int _i75 = 0; _i75 < _list73.size; ++_i75)
          {
            _elem74 = new ByteCodeObject();
            _elem74.read(iprot);
