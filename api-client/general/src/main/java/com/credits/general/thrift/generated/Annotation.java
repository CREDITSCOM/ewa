...
public class Annotation implements org.apache.thrift.TBase<Annotation, Annotation._Fields>, java.io.Serializable, Cloneable, Comparable<Annotation> {
  ...
  public Annotation setArguments(java.util.Map<String, String> arguments) {
    this.arguments = arguments;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.arguments = new java.util.HashMap<String, String>(2*_map34.size);
                String _key35;
                String _val36;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Annotation struct) throws org.apache.thrift.TException {
      ...
      if (struct.arguments != null) {
        oprot.writeFieldBegin(ARGUMENTS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<String, String> _iter38 : struct.arguments.entrySet())
          {
      ...
      if (struct.isSetArguments()) {
        {
          ...
          for (java.util.Map.Entry<String, String> _iter39 : struct.arguments.entrySet())
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.arguments = new java.util.HashMap<String, String>(2*_map40.size);
          String _key41;
          String _val42;
