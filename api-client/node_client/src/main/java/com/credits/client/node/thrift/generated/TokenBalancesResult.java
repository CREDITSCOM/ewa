            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.balances = new java.util.ArrayList<TokenBalance>(_list142.size);
                TokenBalance _elem143;
                for (int _i144 = 0; _i144 < _list142.size; ++_i144)
                {
                  _elem143 = new TokenBalance();
                  _elem143.read(iprot);
                  struct.balances.add(_elem143);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TokenBalancesResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.balances != null) {
        oprot.writeFieldBegin(BALANCES_FIELD_DESC);
        {
          ...
          for (TokenBalance _iter145 : struct.balances)
          {
      ...
      if (struct.isSetBalances()) {
        {
          ...
          for (TokenBalance _iter146 : struct.balances)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.balances = new java.util.ArrayList<TokenBalance>(_list147.size);
          TokenBalance _elem148;
          for (int _i149 = 0; _i149 < _list147.size; ++_i149)
          {
            _elem148 = new TokenBalance();
            _elem148.read(iprot);
            struct.balances.add(_elem148);
          }
        }
        struct.setBalancesIsSet(true);
      }
