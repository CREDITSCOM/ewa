            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.balances = new java.util.ArrayList<TokenBalance>(_list134.size);
                TokenBalance _elem135;
                for (int _i136 = 0; _i136 < _list134.size; ++_i136)
                {
                  _elem135 = new TokenBalance();
                  _elem135.read(iprot);
                  struct.balances.add(_elem135);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TokenBalancesResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.balances != null) {
        oprot.writeFieldBegin(BALANCES_FIELD_DESC);
        {
          ...
          for (TokenBalance _iter137 : struct.balances)
          {
      ...
      if (struct.isSetBalances()) {
        {
          ...
          for (TokenBalance _iter138 : struct.balances)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.balances = new java.util.ArrayList<TokenBalance>(_list139.size);
          TokenBalance _elem140;
          for (int _i141 = 0; _i141 < _list139.size; ++_i141)
          {
            _elem140 = new TokenBalance();
            _elem140.read(iprot);
            struct.balances.add(_elem140);
          }
        }
        struct.setBalancesIsSet(true);
      }
