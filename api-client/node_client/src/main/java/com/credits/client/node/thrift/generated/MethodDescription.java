            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.argTypes = new java.util.ArrayList<java.lang.String>(_list84.size);
                java.lang.String _elem85;
                for (int _i86 = 0; _i86 < _list84.size; ++_i86)
                {
                  _elem85 = iprot.readString();
                  struct.argTypes.add(_elem85);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MethodDescription struct) throws org.apache.thrift.TException {
      ...
      if (struct.argTypes != null) {
        oprot.writeFieldBegin(ARG_TYPES_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter87 : struct.argTypes)
          {
      ...
      if (struct.isSetArgTypes()) {
        {
          ...
          for (java.lang.String _iter88 : struct.argTypes)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.argTypes = new java.util.ArrayList<java.lang.String>(_list89.size);
          java.lang.String _elem90;
          for (int _i91 = 0; _i91 < _list89.size; ++_i91)
          {
            _elem90 = iprot.readString();
            struct.argTypes.add(_elem90);
          }
        }
        struct.setArgTypesIsSet(true);
      }
