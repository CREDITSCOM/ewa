            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.methods = new java.util.ArrayList<SmartContractMethod>(_list100.size);
                SmartContractMethod _elem101;
                for (int _i102 = 0; _i102 < _list100.size; ++_i102)
                {
                  _elem101 = new SmartContractMethod();
                  _elem101.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.variables = new java.util.HashMap<java.lang.String,com.credits.general.thrift.generated.Variant>(2*_map103.size);
                java.lang.String _key104;
                com.credits.general.thrift.generated.Variant _val105;
                for (int _i106 = 0; _i106 < _map103.size; ++_i106)
                {
                  _key104 = iprot.readString();
                  _val105 = new com.credits.general.thrift.generated.Variant();
                  _val105.read(iprot);
                  struct.variables.put(_key104, _val105);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SmartContractDataResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.methods != null) {
        oprot.writeFieldBegin(METHODS_FIELD_DESC);
        {
          ...
          for (SmartContractMethod _iter107 : struct.methods)
          {
      ...
      if (struct.variables != null) {
        oprot.writeFieldBegin(VARIABLES_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, com.credits.general.thrift.generated.Variant> _iter108 : struct.variables.entrySet())
          {
      ...
      if (struct.isSetMethods()) {
        {
          ...
          for (SmartContractMethod _iter109 : struct.methods)
          {
      ...
      if (struct.isSetVariables()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, com.credits.general.thrift.generated.Variant> _iter110 : struct.variables.entrySet())
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.variables = new java.util.HashMap<java.lang.String,com.credits.general.thrift.generated.Variant>(2*_map114.size);
          java.lang.String _key115;
          com.credits.general.thrift.generated.Variant _val116;
          for (int _i117 = 0; _i117 < _map114.size; ++_i117)
          {
            _key115 = iprot.readString();
            _val116 = new com.credits.general.thrift.generated.Variant();
            _val116.read(iprot);
            struct.variables.put(_key115, _val116);
          }
        }
        struct.setVariablesIsSet(true);
      }
