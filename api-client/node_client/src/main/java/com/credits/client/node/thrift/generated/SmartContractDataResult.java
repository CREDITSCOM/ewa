...
public class SmartContractDataResult implements org.apache.thrift.TBase<SmartContractDataResult, SmartContractDataResult._Fields>, java.io.Serializable, Cloneable, Comparable<SmartContractDataResult> {
  ...
  public java.util.List<SmartContractMethod> methods; // required
  public java.util.Map<java.lang.String,com.credits.general.thrift.generated.Variant> variables; // required
  ...
  public SmartContractDataResult setStatus(com.credits.general.thrift.generated.APIResponse status) {
    this.status = status;
    return this;
  }
  ...
  public SmartContractDataResult setMethods(java.util.List<SmartContractMethod> methods) {
    this.methods = methods;
    return this;
  }
  ...
  public SmartContractDataResult setVariables(java.util.Map<java.lang.String,com.credits.general.thrift.generated.Variant> variables) {
    this.variables = variables;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.methods = new java.util.ArrayList<SmartContractMethod>(_list108.size);
                SmartContractMethod _elem109;
                for (int _i110 = 0; _i110 < _list108.size; ++_i110)
                {
                  _elem109 = new SmartContractMethod();
                  _elem109.read(iprot);
                  struct.methods.add(_elem109);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.variables = new java.util.HashMap<java.lang.String,com.credits.general.thrift.generated.Variant>(2*_map111.size);
                java.lang.String _key112;
                com.credits.general.thrift.generated.Variant _val113;
                for (int _i114 = 0; _i114 < _map111.size; ++_i114)
                {
                  _key112 = iprot.readString();
                  _val113 = new com.credits.general.thrift.generated.Variant();
                  _val113.read(iprot);
                  struct.variables.put(_key112, _val113);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SmartContractDataResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.methods != null) {
        oprot.writeFieldBegin(METHODS_FIELD_DESC);
        {
          ...
          for (SmartContractMethod _iter115 : struct.methods)
          {
      ...
      if (struct.variables != null) {
        oprot.writeFieldBegin(VARIABLES_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, com.credits.general.thrift.generated.Variant> _iter116 : struct.variables.entrySet())
          {
      ...
      if (struct.isSetMethods()) {
        {
          ...
          for (SmartContractMethod _iter117 : struct.methods)
          {
      ...
      if (struct.isSetVariables()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, com.credits.general.thrift.generated.Variant> _iter118 : struct.variables.entrySet())
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.methods = new java.util.ArrayList<SmartContractMethod>(_list119.size);
          SmartContractMethod _elem120;
          for (int _i121 = 0; _i121 < _list119.size; ++_i121)
          {
            _elem120 = new SmartContractMethod();
            _elem120.read(iprot);
            struct.methods.add(_elem120);
          }
        }
        struct.setMethodsIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.variables = new java.util.HashMap<java.lang.String,com.credits.general.thrift.generated.Variant>(2*_map122.size);
          java.lang.String _key123;
          com.credits.general.thrift.generated.Variant _val124;
          for (int _i125 = 0; _i125 < _map122.size; ++_i125)
          {
            _key123 = iprot.readString();
            _val124 = new com.credits.general.thrift.generated.Variant();
            _val124.read(iprot);
            struct.variables.put(_key123, _val124);
          }
        }
        struct.setVariablesIsSet(true);
      }
