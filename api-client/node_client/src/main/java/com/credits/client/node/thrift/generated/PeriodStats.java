...
public class PeriodStats implements org.apache.thrift.TBase<PeriodStats, PeriodStats._Fields>, java.io.Serializable, Cloneable, Comparable<PeriodStats> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.balancePerCurrency = new java.util.HashMap<java.lang.Byte,CumulativeAmount>(2*_map32.size);
                byte _key33;
                @org.apache.thrift.annotation.Nullable CumulativeAmount _val34;
                for (int _i35 = 0; _i35 < _map32.size; ++_i35)
                {
                  _key33 = iprot.readByte();
                  _val34 = new CumulativeAmount();
                  _val34.read(iprot);
                  struct.balancePerCurrency.put(_key33, _val34);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PeriodStats struct) throws org.apache.thrift.TException {
      ...
      if (struct.balancePerCurrency != null) {
        oprot.writeFieldBegin(BALANCE_PER_CURRENCY_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.Byte, CumulativeAmount> _iter36 : struct.balancePerCurrency.entrySet())
          {
            oprot.writeByte(_iter36.getKey());
  ...
  private static class PeriodStatsTupleScheme extends org.apache.thrift.scheme.TupleScheme<PeriodStats> {
      ...
      if (struct.isSetBalancePerCurrency()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Byte, CumulativeAmount> _iter37 : struct.balancePerCurrency.entrySet())
          {
            oprot.writeByte(_iter37.getKey());
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, PeriodStats struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TMap _map38 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.BYTE, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.balancePerCurrency = new java.util.HashMap<java.lang.Byte,CumulativeAmount>(2*_map38.size);
          byte _key39;
          @org.apache.thrift.annotation.Nullable CumulativeAmount _val40;
          for (int _i41 = 0; _i41 < _map38.size; ++_i41)
          {
            _key39 = iprot.readByte();
            _val40 = new CumulativeAmount();
            _val40.read(iprot);
            struct.balancePerCurrency.put(_key39, _val40);
          }
        }
        struct.setBalancePerCurrencyIsSet(true);
      }
