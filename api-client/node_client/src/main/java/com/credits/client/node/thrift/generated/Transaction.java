...
public class Transaction implements org.apache.thrift.TBase<Transaction, Transaction._Fields>, java.io.Serializable, Cloneable, Comparable<Transaction> {
  ...
  public java.nio.ByteBuffer comment; // optional
  ...
  private static final _Fields optionals[] = {_Fields.SMART_CONTRACT,_Fields.COMMENT};
  ...
  public java.nio.ByteBuffer bufferForComment() {
    return org.apache.thrift.TBaseHelper.copyBinary(comment);
  }

  public Transaction setComment(byte[] comment) {
    this.comment = comment == null ? (java.nio.ByteBuffer)null : java.nio.ByteBuffer.wrap(comment.clone());
    return this;
  }

  public Transaction setComment(java.nio.ByteBuffer comment) {
    this.comment = org.apache.thrift.TBaseHelper.copyBinary(comment);
    return this;
  }
    ...
    case COMMENT:
      if (value == null) {
        ...
        if (value instanceof byte[]) {
          ...
          setComment((java.nio.ByteBuffer)value);
        }
      }
      break;
