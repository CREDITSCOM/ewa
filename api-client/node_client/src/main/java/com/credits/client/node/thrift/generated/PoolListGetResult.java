            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.pools = new java.util.ArrayList<Pool>(_list50.size);
                @org.apache.thrift.annotation.Nullable Pool _elem51;
                for (int _i52 = 0; _i52 < _list50.size; ++_i52)
                {
                  _elem51 = new Pool();
                  _elem51.read(iprot);
                  struct.pools.add(_elem51);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.pools = new java.util.ArrayList<Pool>(_list55.size);
          @org.apache.thrift.annotation.Nullable Pool _elem56;
          for (int _i57 = 0; _i57 < _list55.size; ++_i57)
          {
            _elem56 = new Pool();
            _elem56.read(iprot);
            struct.pools.add(_elem56);
          }
        }
        struct.setPoolsIsSet(true);
      }
