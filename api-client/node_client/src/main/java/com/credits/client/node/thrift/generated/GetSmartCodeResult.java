            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.byteCodeObjects = new java.util.ArrayList<com.credits.general.thrift.generated.ByteCodeObject>(_list206.size);
                com.credits.general.thrift.generated.ByteCodeObject _elem207;
                for (int _i208 = 0; _i208 < _list206.size; ++_i208)
                {
                  _elem207 = new com.credits.general.thrift.generated.ByteCodeObject();
                  _elem207.read(iprot);
                  struct.byteCodeObjects.add(_elem207);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetSmartCodeResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.byteCodeObjects != null) {
        oprot.writeFieldBegin(BYTE_CODE_OBJECTS_FIELD_DESC);
        {
          ...
          for (com.credits.general.thrift.generated.ByteCodeObject _iter209 : struct.byteCodeObjects)
          {
      ...
      if (struct.isSetByteCodeObjects()) {
        {
          ...
          for (com.credits.general.thrift.generated.ByteCodeObject _iter210 : struct.byteCodeObjects)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.byteCodeObjects = new java.util.ArrayList<com.credits.general.thrift.generated.ByteCodeObject>(_list211.size);
          com.credits.general.thrift.generated.ByteCodeObject _elem212;
          for (int _i213 = 0; _i213 < _list211.size; ++_i213)
          {
            _elem212 = new com.credits.general.thrift.generated.ByteCodeObject();
            _elem212.read(iprot);
            struct.byteCodeObjects.add(_elem212);
          }
        }
        struct.setByteCodeObjectsIsSet(true);
      }
