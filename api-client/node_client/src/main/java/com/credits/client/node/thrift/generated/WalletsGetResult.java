            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.wallets = new java.util.ArrayList<WalletInfo>(_list166.size);
                WalletInfo _elem167;
                for (int _i168 = 0; _i168 < _list166.size; ++_i168)
                {
                  _elem167 = new WalletInfo();
                  _elem167.read(iprot);
                  struct.wallets.add(_elem167);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, WalletsGetResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.wallets != null) {
        oprot.writeFieldBegin(WALLETS_FIELD_DESC);
        {
          ...
          for (WalletInfo _iter169 : struct.wallets)
          {
      ...
      if (struct.isSetWallets()) {
        {
          ...
          for (WalletInfo _iter170 : struct.wallets)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.wallets = new java.util.ArrayList<WalletInfo>(_list171.size);
          WalletInfo _elem172;
          for (int _i173 = 0; _i173 < _list171.size; ++_i173)
          {
            _elem172 = new WalletInfo();
            _elem172.read(iprot);
            struct.wallets.add(_elem172);
          }
        }
        struct.setWalletsIsSet(true);
      }
