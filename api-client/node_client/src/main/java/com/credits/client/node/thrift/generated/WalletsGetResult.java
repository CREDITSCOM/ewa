            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.wallets = new java.util.ArrayList<WalletInfo>(_list182.size);
                WalletInfo _elem183;
                for (int _i184 = 0; _i184 < _list182.size; ++_i184)
                {
                  _elem183 = new WalletInfo();
                  _elem183.read(iprot);
                  struct.wallets.add(_elem183);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, WalletsGetResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.wallets != null) {
        oprot.writeFieldBegin(WALLETS_FIELD_DESC);
        {
          ...
          for (WalletInfo _iter185 : struct.wallets)
          {
      ...
      if (struct.isSetWallets()) {
        {
          ...
          for (WalletInfo _iter186 : struct.wallets)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.wallets = new java.util.ArrayList<WalletInfo>(_list187.size);
          WalletInfo _elem188;
          for (int _i189 = 0; _i189 < _list187.size; ++_i189)
          {
            _elem188 = new WalletInfo();
            _elem188.read(iprot);
            struct.wallets.add(_elem188);
          }
        }
        struct.setWalletsIsSet(true);
      }
