            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.wallets = new java.util.ArrayList<WalletInfo>(_list174.size);
                WalletInfo _elem175;
                for (int _i176 = 0; _i176 < _list174.size; ++_i176)
                {
                  _elem175 = new WalletInfo();
                  _elem175.read(iprot);
                  struct.wallets.add(_elem175);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, WalletsGetResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.wallets != null) {
        oprot.writeFieldBegin(WALLETS_FIELD_DESC);
        {
          ...
          for (WalletInfo _iter177 : struct.wallets)
          {
      ...
      if (struct.isSetWallets()) {
        {
          ...
          for (WalletInfo _iter178 : struct.wallets)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.wallets = new java.util.ArrayList<WalletInfo>(_list179.size);
          WalletInfo _elem180;
          for (int _i181 = 0; _i181 < _list179.size; ++_i181)
          {
            _elem180 = new WalletInfo();
            _elem180.read(iprot);
            struct.wallets.add(_elem180);
          }
        }
        struct.setWalletsIsSet(true);
      }
