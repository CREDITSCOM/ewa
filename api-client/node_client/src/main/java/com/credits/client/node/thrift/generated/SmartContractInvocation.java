...
public class SmartContractInvocation implements org.apache.thrift.TBase<SmartContractInvocation, SmartContractInvocation._Fields>, java.io.Serializable, Cloneable, Comparable<SmartContractInvocation> {
  ...
  private static final org.apache.thrift.protocol.TField EXECUTE_RESULT_FIELD_DESC = new org.apache.thrift.protocol.TField("executeResult", org.apache.thrift.protocol.TType.STRUCT, (short)5);
  ...
  public com.credits.general.thrift.generated.ExecuteByteCodeResult executeResult; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    EXECUTE_RESULT((short)5, "executeResult");
  ...
  private static final _Fields optionals[] = {_Fields.SMART_CONTRACT_DEPLOY,_Fields.EXECUTE_RESULT};
  ...
  static {
    ...
    tmpMap.put(_Fields.EXECUTE_RESULT, new org.apache.thrift.meta_data.FieldMetaData("executeResult", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
  ...
  public SmartContractInvocation(SmartContractInvocation other) {
    ...
    if (other.isSetExecuteResult()) {
      this.executeResult = new com.credits.general.thrift.generated.ExecuteByteCodeResult(other.executeResult);
    }
  }
  ...
  public com.credits.general.thrift.generated.ExecuteByteCodeResult getExecuteResult() {
    return this.executeResult;
  }

  public SmartContractInvocation setExecuteResult(com.credits.general.thrift.generated.ExecuteByteCodeResult executeResult) {
  ...
  /** Returns true if field executeResult is set (has been assigned a value) and false otherwise */
  public boolean isSetExecuteResult() {
    return this.executeResult != null;
  }

  public void setExecuteResultIsSet(boolean value) {
    if (!value) {
      this.executeResult = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case EXECUTE_RESULT:
      if (value == null) {
        ...
        setExecuteResult((com.credits.general.thrift.generated.ExecuteByteCodeResult)value);
      }
      break;
  ...
  public boolean equals(SmartContractInvocation that) {
    ...
    boolean this_present_executeResult = true && this.isSetExecuteResult();
    boolean that_present_executeResult = true && that.isSetExecuteResult();
    if (this_present_executeResult || that_present_executeResult) {
      if (!(this_present_executeResult && that_present_executeResult))
        return false;
      if (!this.executeResult.equals(that.executeResult))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetExecuteResult()) ? 131071 : 524287);
    if (isSetExecuteResult())
      hashCode = hashCode * 8191 + executeResult.hashCode();
  ...
  public int compareTo(SmartContractInvocation other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetExecuteResult()).compareTo(other.isSetExecuteResult());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetExecuteResult()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.executeResult, other.executeResult);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (isSetExecuteResult()) {
      if (!first) sb.append(", ");
      sb.append("executeResult:");
      if (this.executeResult == null) {
        sb.append("null");
      } else {
        sb.append(this.executeResult);
      }
      first = false;
    }
    sb.append(")");
  ...
  private static class SmartContractInvocationStandardScheme extends org.apache.thrift.scheme.StandardScheme<SmartContractInvocation> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, SmartContractInvocation struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 5: // EXECUTE_RESULT
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.executeResult = new com.credits.general.thrift.generated.ExecuteByteCodeResult();
              struct.executeResult.read(iprot);
              struct.setExecuteResultIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SmartContractInvocation struct) throws org.apache.thrift.TException {
      ...
      if (struct.executeResult != null) {
        if (struct.isSetExecuteResult()) {
          oprot.writeFieldBegin(EXECUTE_RESULT_FIELD_DESC);
          struct.executeResult.write(oprot);
          oprot.writeFieldEnd();
        }
      }
      ...
      if (incoming.get(1)) {
        {
          ...
          com.credits.general.thrift.generated.Variant _elem14;
