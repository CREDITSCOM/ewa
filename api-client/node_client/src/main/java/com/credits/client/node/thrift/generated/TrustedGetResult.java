            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.writers = new java.util.ArrayList<TrustedInfo>(_list206.size);
                TrustedInfo _elem207;
                for (int _i208 = 0; _i208 < _list206.size; ++_i208)
                {
                  _elem207 = new TrustedInfo();
                  _elem207.read(iprot);
                  struct.writers.add(_elem207);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TrustedGetResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.writers != null) {
        oprot.writeFieldBegin(WRITERS_FIELD_DESC);
        {
          ...
          for (TrustedInfo _iter209 : struct.writers)
          {
      ...
      if (struct.isSetWriters()) {
        {
          ...
          for (TrustedInfo _iter210 : struct.writers)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.writers = new java.util.ArrayList<TrustedInfo>(_list211.size);
          TrustedInfo _elem212;
          for (int _i213 = 0; _i213 < _list211.size; ++_i213)
          {
            _elem212 = new TrustedInfo();
            _elem212.read(iprot);
            struct.writers.add(_elem212);
          }
        }
        struct.setWritersIsSet(true);
      }
