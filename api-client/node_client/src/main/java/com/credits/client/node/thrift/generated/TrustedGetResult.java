            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.writers = new java.util.ArrayList<TrustedInfo>(_list190.size);
                TrustedInfo _elem191;
                for (int _i192 = 0; _i192 < _list190.size; ++_i192)
                {
                  _elem191 = new TrustedInfo();
                  _elem191.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TrustedGetResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.writers != null) {
        oprot.writeFieldBegin(WRITERS_FIELD_DESC);
        {
          ...
          for (TrustedInfo _iter193 : struct.writers)
          {
      ...
      if (struct.isSetWriters()) {
        {
          ...
          for (TrustedInfo _iter194 : struct.writers)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.writers = new java.util.ArrayList<TrustedInfo>(_list195.size);
          TrustedInfo _elem196;
          for (int _i197 = 0; _i197 < _list195.size; ++_i197)
          {
            _elem196 = new TrustedInfo();
            _elem196.read(iprot);
