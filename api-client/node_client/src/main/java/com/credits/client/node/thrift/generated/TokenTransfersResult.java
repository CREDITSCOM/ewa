            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.transfers = new java.util.ArrayList<TokenTransfer>(_list142.size);
                TokenTransfer _elem143;
                for (int _i144 = 0; _i144 < _list142.size; ++_i144)
                {
                  _elem143 = new TokenTransfer();
                  _elem143.read(iprot);
                  struct.transfers.add(_elem143);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TokenTransfersResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.transfers != null) {
        oprot.writeFieldBegin(TRANSFERS_FIELD_DESC);
        {
          ...
          for (TokenTransfer _iter145 : struct.transfers)
          {
      ...
      if (struct.isSetTransfers()) {
        {
          ...
          for (TokenTransfer _iter146 : struct.transfers)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.transfers = new java.util.ArrayList<TokenTransfer>(_list147.size);
          TokenTransfer _elem148;
          for (int _i149 = 0; _i149 < _list147.size; ++_i149)
          {
            _elem148 = new TokenTransfer();
            _elem148.read(iprot);
            struct.transfers.add(_elem148);
          }
        }
        struct.setTransfersIsSet(true);
      }
