            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.transfers = new java.util.ArrayList<TokenTransfer>(_list150.size);
                TokenTransfer _elem151;
                for (int _i152 = 0; _i152 < _list150.size; ++_i152)
                {
                  _elem151 = new TokenTransfer();
                  _elem151.read(iprot);
                  struct.transfers.add(_elem151);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TokenTransfersResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.transfers != null) {
        oprot.writeFieldBegin(TRANSFERS_FIELD_DESC);
        {
          ...
          for (TokenTransfer _iter153 : struct.transfers)
          {
      ...
      if (struct.isSetTransfers()) {
        {
          ...
          for (TokenTransfer _iter154 : struct.transfers)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.transfers = new java.util.ArrayList<TokenTransfer>(_list155.size);
          TokenTransfer _elem156;
          for (int _i157 = 0; _i157 < _list155.size; ++_i157)
          {
            _elem156 = new TokenTransfer();
            _elem156.read(iprot);
            struct.transfers.add(_elem156);
          }
        }
        struct.setTransfersIsSet(true);
      }
