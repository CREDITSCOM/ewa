            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.transactions = new java.util.ArrayList<TokenTransaction>(_list174.size);
                TokenTransaction _elem175;
                for (int _i176 = 0; _i176 < _list174.size; ++_i176)
                {
                  _elem175 = new TokenTransaction();
                  _elem175.read(iprot);
                  struct.transactions.add(_elem175);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TokenTransactionsResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.transactions != null) {
        oprot.writeFieldBegin(TRANSACTIONS_FIELD_DESC);
        {
          ...
          for (TokenTransaction _iter177 : struct.transactions)
          {
      ...
      if (struct.isSetTransactions()) {
        {
          ...
          for (TokenTransaction _iter178 : struct.transactions)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.transactions = new java.util.ArrayList<TokenTransaction>(_list179.size);
          TokenTransaction _elem180;
          for (int _i181 = 0; _i181 < _list179.size; ++_i181)
          {
            _elem180 = new TokenTransaction();
            _elem180.read(iprot);
            struct.transactions.add(_elem180);
          }
        }
        struct.setTransactionsIsSet(true);
      }
