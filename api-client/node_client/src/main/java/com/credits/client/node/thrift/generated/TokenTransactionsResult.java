            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.transactions = new java.util.ArrayList<TokenTransaction>(_list158.size);
                TokenTransaction _elem159;
                for (int _i160 = 0; _i160 < _list158.size; ++_i160)
                {
                  _elem159 = new TokenTransaction();
                  _elem159.read(iprot);
                  struct.transactions.add(_elem159);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TokenTransactionsResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.transactions != null) {
        oprot.writeFieldBegin(TRANSACTIONS_FIELD_DESC);
        {
          ...
          for (TokenTransaction _iter161 : struct.transactions)
          {
      ...
      if (struct.isSetTransactions()) {
        {
          ...
          for (TokenTransaction _iter162 : struct.transactions)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.transactions = new java.util.ArrayList<TokenTransaction>(_list163.size);
          TokenTransaction _elem164;
          for (int _i165 = 0; _i165 < _list163.size; ++_i165)
          {
            _elem164 = new TokenTransaction();
            _elem164.read(iprot);
            struct.transactions.add(_elem164);
          }
        }
        struct.setTransactionsIsSet(true);
      }
