            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.transactions = new java.util.ArrayList<TokenTransaction>(_list150.size);
                TokenTransaction _elem151;
                for (int _i152 = 0; _i152 < _list150.size; ++_i152)
                {
                  _elem151 = new TokenTransaction();
                  _elem151.read(iprot);
                  struct.transactions.add(_elem151);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TokenTransactionsResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.transactions != null) {
        oprot.writeFieldBegin(TRANSACTIONS_FIELD_DESC);
        {
          ...
          for (TokenTransaction _iter153 : struct.transactions)
          {
      ...
      if (struct.isSetTransactions()) {
        {
          ...
          for (TokenTransaction _iter154 : struct.transactions)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.transactions = new java.util.ArrayList<TokenTransaction>(_list155.size);
          TokenTransaction _elem156;
          for (int _i157 = 0; _i157 < _list155.size; ++_i157)
          {
            _elem156 = new TokenTransaction();
            _elem156.read(iprot);
            struct.transactions.add(_elem156);
          }
        }
        struct.setTransactionsIsSet(true);
      }
