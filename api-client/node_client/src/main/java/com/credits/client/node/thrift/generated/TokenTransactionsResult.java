            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.transactions = new java.util.ArrayList<TokenTransaction>(_list142.size);
                TokenTransaction _elem143;
                for (int _i144 = 0; _i144 < _list142.size; ++_i144)
                {
                  _elem143 = new TokenTransaction();
                  _elem143.read(iprot);
                  struct.transactions.add(_elem143);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TokenTransactionsResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.transactions != null) {
        oprot.writeFieldBegin(TRANSACTIONS_FIELD_DESC);
        {
          ...
          for (TokenTransaction _iter145 : struct.transactions)
          {
      ...
      if (struct.isSetTransactions()) {
        {
          ...
          for (TokenTransaction _iter146 : struct.transactions)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.transactions = new java.util.ArrayList<TokenTransaction>(_list147.size);
          TokenTransaction _elem148;
          for (int _i149 = 0; _i149 < _list147.size; ++_i149)
          {
            _elem148 = new TokenTransaction();
            _elem148.read(iprot);
            struct.transactions.add(_elem148);
          }
        }
        struct.setTransactionsIsSet(true);
      }
