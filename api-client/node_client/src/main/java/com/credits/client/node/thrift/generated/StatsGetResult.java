            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.stats = new java.util.ArrayList<PeriodStats>(_list66.size);
                PeriodStats _elem67;
                for (int _i68 = 0; _i68 < _list66.size; ++_i68)
                {
                  _elem67 = new PeriodStats();
                  _elem67.read(iprot);
                  struct.stats.add(_elem67);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, StatsGetResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.stats != null) {
        oprot.writeFieldBegin(STATS_FIELD_DESC);
        {
          ...
          for (PeriodStats _iter69 : struct.stats)
          {
            _iter69.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetStats()) {
        {
          ...
          for (PeriodStats _iter70 : struct.stats)
          {
            _iter70.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.stats = new java.util.ArrayList<PeriodStats>(_list71.size);
          PeriodStats _elem72;
          for (int _i73 = 0; _i73 < _list71.size; ++_i73)
          {
            _elem72 = new PeriodStats();
            _elem72.read(iprot);
            struct.stats.add(_elem72);
          }
        }
        struct.setStatsIsSet(true);
      }
