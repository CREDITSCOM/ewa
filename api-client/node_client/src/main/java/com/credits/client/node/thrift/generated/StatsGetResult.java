            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.stats = new java.util.ArrayList<PeriodStats>(_list50.size);
                PeriodStats _elem51;
                for (int _i52 = 0; _i52 < _list50.size; ++_i52)
                {
                  _elem51 = new PeriodStats();
                  _elem51.read(iprot);
                  struct.stats.add(_elem51);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, StatsGetResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.stats != null) {
        oprot.writeFieldBegin(STATS_FIELD_DESC);
        {
          ...
          for (PeriodStats _iter53 : struct.stats)
          {
            _iter53.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetStats()) {
        {
          ...
          for (PeriodStats _iter54 : struct.stats)
          {
            _iter54.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.stats = new java.util.ArrayList<PeriodStats>(_list55.size);
          PeriodStats _elem56;
          for (int _i57 = 0; _i57 < _list55.size; ++_i57)
          {
            _elem56 = new PeriodStats();
            _elem56.read(iprot);
            struct.stats.add(_elem56);
          }
        }
        struct.setStatsIsSet(true);
      }
