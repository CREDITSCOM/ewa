            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.arguments = new java.util.ArrayList<SmartContractMethodArgument>(_list92.size);
                SmartContractMethodArgument _elem93;
                for (int _i94 = 0; _i94 < _list92.size; ++_i94)
                {
                  _elem93 = new SmartContractMethodArgument();
                  _elem93.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SmartContractMethod struct) throws org.apache.thrift.TException {
      ...
      if (struct.arguments != null) {
        oprot.writeFieldBegin(ARGUMENTS_FIELD_DESC);
        {
          ...
          for (SmartContractMethodArgument _iter95 : struct.arguments)
          {
            _iter95.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetArguments()) {
        {
          ...
          for (SmartContractMethodArgument _iter96 : struct.arguments)
          {
            _iter96.write(oprot);
          }
        }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.arguments = new java.util.ArrayList<SmartContractMethodArgument>(_list97.size);
          SmartContractMethodArgument _elem98;
          for (int _i99 = 0; _i99 < _list97.size; ++_i99)
          {
            _elem98 = new SmartContractMethodArgument();
            _elem98.read(iprot);
