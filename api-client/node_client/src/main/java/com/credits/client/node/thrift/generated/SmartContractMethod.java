            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.arguments = new java.util.ArrayList<SmartContractMethodArgument>(_list116.size);
                SmartContractMethodArgument _elem117;
                for (int _i118 = 0; _i118 < _list116.size; ++_i118)
                {
                  _elem117 = new SmartContractMethodArgument();
                  _elem117.read(iprot);
                  struct.arguments.add(_elem117);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SmartContractMethod struct) throws org.apache.thrift.TException {
      ...
      if (struct.arguments != null) {
        oprot.writeFieldBegin(ARGUMENTS_FIELD_DESC);
        {
          ...
          for (SmartContractMethodArgument _iter119 : struct.arguments)
          {
      ...
      if (struct.isSetArguments()) {
        {
          ...
          for (SmartContractMethodArgument _iter120 : struct.arguments)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.arguments = new java.util.ArrayList<SmartContractMethodArgument>(_list121.size);
          SmartContractMethodArgument _elem122;
          for (int _i123 = 0; _i123 < _list121.size; ++_i123)
          {
            _elem122 = new SmartContractMethodArgument();
            _elem122.read(iprot);
            struct.arguments.add(_elem122);
          }
        }
        struct.setArgumentsIsSet(true);
      }
