            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.writers = new java.util.ArrayList<WriterInfo>(_list190.size);
                WriterInfo _elem191;
                for (int _i192 = 0; _i192 < _list190.size; ++_i192)
                {
                  _elem191 = new WriterInfo();
                  _elem191.read(iprot);
                  struct.writers.add(_elem191);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, WritersGetResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.writers != null) {
        oprot.writeFieldBegin(WRITERS_FIELD_DESC);
        {
          ...
          for (WriterInfo _iter193 : struct.writers)
          {
      ...
      if (struct.isSetWriters()) {
        {
          ...
          for (WriterInfo _iter194 : struct.writers)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.writers = new java.util.ArrayList<WriterInfo>(_list195.size);
          WriterInfo _elem196;
          for (int _i197 = 0; _i197 < _list195.size; ++_i197)
          {
            _elem196 = new WriterInfo();
            _elem196.read(iprot);
            struct.writers.add(_elem196);
          }
        }
        struct.setWritersIsSet(true);
      }
