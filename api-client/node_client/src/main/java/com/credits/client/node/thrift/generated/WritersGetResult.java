            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.writers = new java.util.ArrayList<WriterInfo>(_list182.size);
                WriterInfo _elem183;
                for (int _i184 = 0; _i184 < _list182.size; ++_i184)
                {
                  _elem183 = new WriterInfo();
                  _elem183.read(iprot);
                  struct.writers.add(_elem183);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, WritersGetResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.writers != null) {
        oprot.writeFieldBegin(WRITERS_FIELD_DESC);
        {
          ...
          for (WriterInfo _iter185 : struct.writers)
          {
      ...
      if (struct.isSetWriters()) {
        {
          ...
          for (WriterInfo _iter186 : struct.writers)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.writers = new java.util.ArrayList<WriterInfo>(_list187.size);
          WriterInfo _elem188;
          for (int _i189 = 0; _i189 < _list187.size; ++_i189)
          {
            _elem188 = new WriterInfo();
            _elem188.read(iprot);
            struct.writers.add(_elem188);
          }
        }
        struct.setWritersIsSet(true);
      }
