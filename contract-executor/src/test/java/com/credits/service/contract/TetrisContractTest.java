...
public class TetrisContractTest extends ServiceTest {
    ...
    public void tetrisContractTest() throws Exception {
        ...
        ReturnValue executeValueGetBalances = ceService.execute(address, bytecode, deployValue.getContractState(), "getBalance", new Variant[][]{{ContractUtils.mapVariantDataToVariant(new VariantData(VariantType.INT, 0))}},500L);
