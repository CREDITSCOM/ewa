...
public class GetContractMethodsResult implements org.apache.thrift.TBase<GetContractMethodsResult, GetContractMethodsResult._Fields>, java.io.Serializable, Cloneable, Comparable<GetContractMethodsResult> {
  ...
  public GetContractMethodsResult setCode(byte code) {
    this.code = code;
    setCodeIsSet(true);
    return this;
  }
  ...
  public GetContractMethodsResult setMessage(java.lang.String message) {
    this.message = message;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.methods = new java.util.ArrayList<MethodDescription>(_list18.size);
                MethodDescription _elem19;
                for (int _i20 = 0; _i20 < _list18.size; ++_i20)
                {
                  _elem19 = new MethodDescription();
                  _elem19.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetContractMethodsResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.methods != null) {
        oprot.writeFieldBegin(METHODS_FIELD_DESC);
        {
          ...
          for (MethodDescription _iter21 : struct.methods)
          {
            _iter21.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetMethods()) {
        {
          ...
          for (MethodDescription _iter22 : struct.methods)
          {
            _iter22.write(oprot);
          }
        }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.methods = new java.util.ArrayList<MethodDescription>(_list23.size);
          MethodDescription _elem24;
          for (int _i25 = 0; _i25 < _list23.size; ++_i25)
          {
            _elem24 = new MethodDescription();
            _elem24.read(iprot);
