...
public class APIResponse implements org.apache.thrift.TBase<APIResponse, APIResponse._Fields>, java.io.Serializable, Cloneable, Comparable<APIResponse> {
  ...
  public com.credits.general.thrift.Variant ret_val; // optional
  public java.util.Map<java.lang.String,com.credits.general.thrift.Variant> contractVariables; // optional
  ...
  public APIResponse(APIResponse other) {
    ...
    if (other.isSetRet_val()) {
      this.ret_val = new com.credits.general.thrift.Variant(other.ret_val);
    }
    if (other.isSetContractVariables()) {
      java.util.Map<java.lang.String,com.credits.general.thrift.Variant> __this__contractVariables = new java.util.HashMap<java.lang.String,com.credits.general.thrift.Variant>(other.contractVariables.size());
      for (java.util.Map.Entry<java.lang.String, com.credits.general.thrift.Variant> other_element : other.contractVariables.entrySet()) {

        java.lang.String other_element_key = other_element.getKey();
        com.credits.general.thrift.Variant other_element_value = other_element.getValue();

        java.lang.String __this__contractVariables_copy_key = other_element_key;

        com.credits.general.thrift.Variant __this__contractVariables_copy_value = new com.credits.general.thrift.Variant(other_element_value);
  ...
  public com.credits.general.thrift.Variant getRet_val() {
    return this.ret_val;
  }

  public APIResponse setRet_val(com.credits.general.thrift.Variant ret_val) {
  ...
  public void putToContractVariables(java.lang.String key, com.credits.general.thrift.Variant val) {
    if (this.contractVariables == null) {
      this.contractVariables = new java.util.HashMap<java.lang.String,com.credits.general.thrift.Variant>();
    }
    this.contractVariables.put(key, val);
  }

  public java.util.Map<java.lang.String,com.credits.general.thrift.Variant> getContractVariables() {
    return this.contractVariables;
  }

  public APIResponse setContractVariables(java.util.Map<java.lang.String,com.credits.general.thrift.Variant> contractVariables) {
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case RET_VAL:
      if (value == null) {
        ...
        setRet_val((com.credits.general.thrift.Variant)value);
      }
      break;
    ...
    case CONTRACT_VARIABLES:
      if (value == null) {
        ...
        setContractVariables((java.util.Map<java.lang.String,com.credits.general.thrift.Variant>)value);
      }
      break;
        ...
        switch (schemeField.id) {
          ...
          case 4: // RET_VAL
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.ret_val = new com.credits.general.thrift.Variant();
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.contractVariables = new java.util.HashMap<java.lang.String,com.credits.general.thrift.Variant>(2*_map0.size);
                java.lang.String _key1;
                com.credits.general.thrift.Variant _val2;
                for (int _i3 = 0; _i3 < _map0.size; ++_i3)
                {
                  _key1 = iprot.readString();
                  _val2 = new com.credits.general.thrift.Variant();
                  _val2.read(iprot);
      ...
      if (struct.contractVariables != null) {
        if (struct.isSetContractVariables()) {
          oprot.writeFieldBegin(CONTRACT_VARIABLES_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, com.credits.general.thrift.Variant> _iter4 : struct.contractVariables.entrySet())
            {
      ...
      if (struct.isSetContractVariables()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, com.credits.general.thrift.Variant> _iter5 : struct.contractVariables.entrySet())
          {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.contractVariables = new java.util.HashMap<java.lang.String,com.credits.general.thrift.Variant>(2*_map6.size);
          java.lang.String _key7;
          com.credits.general.thrift.Variant _val8;
          for (int _i9 = 0; _i9 < _map6.size; ++_i9)
          {
            _key7 = iprot.readString();
            _val8 = new com.credits.general.thrift.Variant();
            _val8.read(iprot);
