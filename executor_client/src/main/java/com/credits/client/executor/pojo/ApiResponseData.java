...
public class ApiResponseData {
    ...
    public ApiResponseData(byte code, String message, Variant scExecRetVal) {
        this.code = code;
    ...
    public Variant getSmartContractReturnValue() {
        return scExecRetVal;
    }

    public void setContractReturnValue(Variant scRetVal) {
        this.scExecRetVal = scRetVal;
    }
